...
public class DriverScript extends BrowserHandling
{
	...
	{		
		...
		//6. Enter First Name
		driver.findElement(By.xpath("//label[contains(text(),'First Name')]/following-sibling::div//input")).sendKeys(firstName);
		//7. Enter Last Name
		driver.findElement(By.xpath("//label[contains(text(),'Last Name')]/following-sibling::div//input")).sendKeys(lastName);
		//8. Enter Email ID
		driver.findElement(By.xpath("//label[contains(text(),'E-Mail')]/following-sibling::div//input")).sendKeys(email);
